...
//delete products
        ...
        if(isset($_GET['idrow'])){
            $id = $_GET['idrow'];
            $statement = ("DELETE FROM Customers WHERE idCustomer='$id'");
                            ...
                            <div class="select-box">
                                <div class="select-box__current" tabindex="1">
                                    <div class="select-box__value">
                                        ...
                                        <p class="select-box__input-text">Viewing Customer Records</p>
                                    </div>
                                        <div class="select-box__value">
                                ...
                                <?php foreach($result as $row){
                                    ...
                                    $id = $row['idCustomer'];
                                        echo "<tr>";
                                            ...
                                            echo"<td>"."<a href='customer_delete.php?idrow=$id'>Delete Record</a>"."</td>";
                                        echo "</tr>";
                                    echo "</tbody>";
                                }
                                ?>   
